...
Arv lar deg få funksjoner fra en klasse over til en annen en. For arve disse funksjonene fra en klasse, må man bruke Super

## Eksempler på arv

Her er et eksempel på en Super klasse
```Python
class Bruker():
...
Her er sub klassen som arver fra Super klassen
```Python
class Lærer(Bruker):
...
Her er et eksempel på et større program hvor man kan bruke Super klasser.
